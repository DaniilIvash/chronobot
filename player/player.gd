...
func player_animations():
	...
	elif current_state == State.Run and animated_sprite_2d.animation != "run_shoot" && is_on_floor():
		animated_sprite_2d.play("run")
	elif  current_state == State.Jump:
		animated_sprite_2d.play("jump")
	elif  current_state == State.Shoot and animated_sprite_2d.animation != "jump" and direction != 0:
